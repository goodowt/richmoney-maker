...
export const yearEndTaxFaq: FaqItem[] = [
  {
  ...
  {
    question: "신용카드와 체크카드 중 뭘 더 많이 쓰는 게 유리한가요?",
    answer:
  ...
  {
    question: "표준세액공제(13만원)와 항목별 공제 중 뭐가 유리한지 어떻게 확인하나요?",
    answer:
  ...
  {
    question: "연금저축과 IRP는 얼마까지 넣어야 세액공제를 최대로 받나요?",
    answer:
  ...
  {
    question: "이 계산기 결과와 회사에서 정산한 실제 금액이 다른데 왜 그런가요?",
    answer:
