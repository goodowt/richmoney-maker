  ...
  return (
    <div className="mt-10 space-y-10">
      ...
      <section aria-labelledby="rate-heading">
        ...
        <dl className="mt-3 space-y-3 text-sm leading-relaxed text-black/70 dark:text-white/70">
          <div>
            <dt className="font-medium text-black dark:text-white">국민연금</dt>
            <dd>지금 낸 돈을 나중에 나이가 들었을 때(보통 만 65세부터) 매달 연금으로 돌려받아요.</dd>
          </div>
          <div>
            <dt className="font-medium text-black dark:text-white">건강보험</dt>
            <dd>병원에 갈 때 진료비·약값을 훨씬 싸게 내도록 도와주는 보험이에요.</dd>
          </div>
          <div>
            <dt className="font-medium text-black dark:text-white">장기요양보험</dt>
            <dd>
          ...
          <div>
            <dt className="font-medium text-black dark:text-white">고용보험</dt>
